...
Devise.setup do |config|
  ...
  config.warden do |manager|
    ...
    # For sign_in, only use database authentication, not JWT
    manager.default_strategies(scope: :user, store: false).unshift :database_authenticatable
  end
  ...
  config.jwt do |jwt|
    ...
    # Don't use aud_header to allow sign_in without JWT
    jwt.aud_header = 'JWT'
  end
